...
const updatePage = async () => {
  ...
  const newArray = fruitsArray.filter(fruit => {
    return fruit.name.includes('y')
  })
  ...
  newEle.innerHTML = newArray.map(fruit => {
    return fruit.name
  })

  // TODO: Append your new element to the page
  const existingEle = document.getElementById('cs1300-gallery');
